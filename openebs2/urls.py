...
from utils.views import handler403, handler404, handler500, login_view, logout_view
...
urlpatterns = [
    ...
    url(r'^login-form/$', auth_views.LoginView.as_view(template_name='users/login.html'), name="app_login"),
