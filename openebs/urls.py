...
from openebs.views_change import ChangeListView, ChangeCreateView, ChangeDeleteView, ActiveJourneysAjaxView, ChangeUpdateView, NotMonitoredAjaxView
...
urlpatterns = [
    ...
    url(r'^ritaanpassing/nietgevolgd.json$', NotMonitoredAjaxView.as_view(), name="notMonitored_journeys_ajax"),
